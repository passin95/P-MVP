package me.yokeyword.fragmentation.mvp.demo_wechat.ui.view;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.fragmentation_tab_unselect));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.fragmentation_tab_unselect));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.fragmentation_bg_msg_bubble);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.fragmentation_colorPrimary));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.fragmentation_colorPrimary));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.fragmentation_tab_unselect));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.fragmentation_tab_unselect));
        }
    }
