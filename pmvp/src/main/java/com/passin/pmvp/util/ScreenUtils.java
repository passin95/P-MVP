...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) PmvpUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return PmvpUtils.getApp().getResources().getDisplayMetrics().widthPixels;
        }
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) PmvpUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return PmvpUtils.getResources().getDisplayMetrics().heightPixels;
        }
        Point point = new Point();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            wm.getDefaultDisplay().getRealSize(point);
    ...
    public static float getScreenDensity() {
        return PmvpUtils.getResources().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return PmvpUtils.getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean isLandscape() {
        return PmvpUtils.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) PmvpUtils.getApp().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                PmvpUtils.getApp().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (PmvpUtils.getApp().getResources().getConfiguration().screenLayout
